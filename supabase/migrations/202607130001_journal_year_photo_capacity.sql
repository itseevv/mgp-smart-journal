...
begin
  ...
  select count(*) into existing_photo_count
  from public.photos
  ...
  if requested_memory_id is null
    ...
    or (
      ...
      and jsonb_array_length(requested_photos) > existing_photo_count
    )
...
revoke all on function public.journal_photo_capacity() from public;
